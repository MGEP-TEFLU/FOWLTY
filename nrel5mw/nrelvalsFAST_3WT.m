...
wg_rated    = 121.6805; % From discon.f90                    % 1173.7*pi/30; %[rad/s]
...
wg_rated2   = 1173.7*pi/30;
wg_r        = 0:wg_res:wg_rated2;
wg_25       = 120.8;%119.6004;%119.0138;
wg_15       = 70.4;%60;
wg_2        = 91.2;%64;
...
VS_Slope25  = M_rated/(wg_rated2 - VS_SySp);%

M_r = zeros(size(wg_r));
for i = 1:length(M_r)
    if wg_r(i) > wg_rated2     % > 121.6805
        M_r(i) = VS_RtPwr/wg_r(i);
...
% figure; plot(wg_r,M_r)
% figure; plot(wg_r*30/pi,M_r/1000)
